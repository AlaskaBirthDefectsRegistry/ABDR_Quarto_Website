---
title: "Encephalocele 2007-`r as.numeric(format(Sys.time(), '%Y')) - 3`"
...
### Prevalence   
Encephalocele occurs in **0.95 (95% CI 0.87–1.04) out of every 10,000 live births in the United States.** This results in about 340 babies diagnosed with encephalocele nationally each year.[[5]](#references) 
...
# Loading the ENC
ev2 <- readRDS("R:/ABDR/Analysis_New/ABDR_CASECONF/cond_reports/Published_reports/abdr_website/images/ev2_num_ENC.rds") #
...
tmp <- readRDS("R:\\ABDR\\Analysis_New\\ABDR_CASECONF\\cond_reports\\Published_reports\\abdr_website\\images\\tmp_ENC.rds")
tmp[[1]]
```  
...
library(plotly)
 ...
 trend <- readRDS("R:\\ABDR\\Analysis_New\\ABDR_CASECONF\\cond_reports\\Published_reports\\abdr_website\\images\\trend_nma_ENC.rds")
  
 trend_table <- readRDS("R:\\ABDR\\Analysis_New\\ABDR_CASECONF\\cond_reports\\Published_reports\\abdr_website\\images\\trend_table_nma_ENC.rds")
...
#| echo: false
 ...
 p_val <- readRDS("R:\\ABDR\\Analysis_New\\ABDR_CASECONF\\cond_reports\\Published_reports\\abdr_website\\images\\trend_p_table_ENC.rds")
...
geo_plot <- readRDS("R:\\ABDR\\Analysis_New\\ABDR_CASECONF\\cond_reports\\Published_reports\\abdr_website\\images\\sf_plot_map_ENC.rds")
 ggplotly(geo_plot) %>%
  layout(xaxis = list(autorange = TRUE),
         yaxis = list(autorange = TRUE))

geo_tbl <- readRDS("R:\\ABDR\\Analysis_New\\ABDR_CASECONF\\cond_reports\\Published_reports\\abdr_website\\images\\geo_tbl_ENC.rds")
...
t6 <- readRDS("R:/ABDR/Analysis_New/ABDR_CASECONF/cond_reports/Published_reports/abdr_website/images/t6_ENC.Rds")
t7 <- readRDS("R:/ABDR/Analysis_New/ABDR_CASECONF/cond_reports/Published_reports/abdr_website/images/t7_ENC.Rds")
...
plot <- readRDS("R:/ABDR/Analysis_New/ABDR_CASECONF/cond_reports/Published_reports/abdr_website/images/accomp_diag_ENC.Rds")
...
## References
[[1]]( https://www.cdc.gov/ncbddd/birthdefects/encephalocele.html) Centers for Disease Control and Prevention. Facts about Encephalocele https<span></span>://www.cdc.gov/ncbddd/birthdefects/ encephalocele.html; 2016 [accessed 03.06.2017]  

[[2]]( https://rarediseases.org/rare-diseases/encephalocele/) National Organization for Rare Disorders. Encephalocele, https<span></span>:// rarediseases.org/rare-diseases/encephalocele/; 2012 [accessed 03.06.2017]  

[[3]](https://www.cdc.gov/mmwr/preview/mmwrhtml/mm6401a2.htm) Centers for Disease Control and Prevention. Updated Estimates of Neural Tube Defects Prevented by Mandatory Folic Acid Fortification - United States, 1995-2011. MMWR Morb Mort Wkly Rep. 2015: 64(01); 1-5.  
...
##Resources 
[Centers for Disease Control and Prevention](https://www.cdc.gov/ncbddd/birthdefects/encephalocele.html)   
...
## Suggested Citation
State of Alaska Department of Health, Division of Public Health, Section of Women's, Children's, and Family Health. Alaska Birth Defects Registry Condition Report: Encephalocele, Alaska, 2007-`r as.numeric(format(Sys.time(), '%Y')) - 3`. Updated `r format(Sys.time(), '%B %d, %Y')`. Available at: http://rpubs.com/AK_ABDR/Encephalocele
...
*Code source:* ```R:\ABDR\Website\ABDR_Quarto_Website\Encephalocele_tar.qmd``` 
