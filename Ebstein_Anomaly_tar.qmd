---
title: "Ebstein Anomaly 2007-`r as.numeric(format(Sys.time(), '%Y')) - 3`"
...
Ebstein Anomaly is a rare birth defect of the heart characterized by a malformation of the tricuspid valve (a valve between the upper and lower chambers of the right side of the heart). In Ebstein anomaly, the tricuspid valve is misshapen and displaced lower than normal leading to excess blood flow to the right atrium causing it to be enlarged and potentially leading to congestive heart failure over time. [[1]](#references) Ebstein anomaly is often associated with a communication between the right and left atria (atrial septal defect) which allows oxygen-poor blood for the right side of the heart to mix with oxygen-rich blood on the left side. Symptoms and signs of ebstein anomaly can include shortness of breath, lethargy, heart palpitations and cyanosis (bluish skin tone). [[2]](#references) Ebstein anomaly does not have a specific cause, however, both genetic and environmental factors are believed to contribute. [[3]](#references) Diagnosis is possible during pregnancy using ultrasound or after birth by echocardiogram. [[1]](#references) Treatment, when necessary, includes open-heart surgery to repair or replace the tricuspid valve. Because an infant with Ebstein anomaly may need these procedures soon after birth, this defect is considered a critical congenital heart defect. 

<br>

<iframe width="812" height="456.75" src="https://www.youtube.com/embed/725x0XYQmns" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen data-external = "1"></iframe>
...
### Prevalence   
Ebstein anomaly occurs in **0.77 (95% CI 0.69–0.85) in every 10,000 live births in the United States.** [[5]](#references)
...
# Loading the EBSTE
ev2 <- readRDS("R:/ABDR/Analysis_New/ABDR_CASECONF/cond_reports/Published_reports/abdr_website/images/ev2_num_EBSTE.rds") #
...
tmp <- readRDS("R:\\ABDR\\Analysis_New\\ABDR_CASECONF\\cond_reports\\Published_reports\\abdr_website\\images\\tmp_EBSTE.rds")
tmp[[1]]
```   
...
library(plotly)
 ...
 trend <- readRDS("R:\\ABDR\\Analysis_New\\ABDR_CASECONF\\cond_reports\\Published_reports\\abdr_website\\images\\trend_nma_EBSTE.rds")
  
 trend_table <- readRDS("R:\\ABDR\\Analysis_New\\ABDR_CASECONF\\cond_reports\\Published_reports\\abdr_website\\images\\trend_table_nma_EBSTE.rds")
...
The p-value test for trend detected a significant decrease in number of live births  with `r condition[1]` during `r datYRS[1]`. See [p-value estimate](#p-value-estimate)
<center>
```{r} 
#| warning: false 
#| message: FALSE 
...
p_val <- readRDS("R:\\ABDR\\Analysis_New\\ABDR_CASECONF\\cond_reports\\Published_reports\\abdr_website\\images\\trend_p_table_EBSTE.rds")
...
geo_plot <- readRDS("R:\\ABDR\\Analysis_New\\ABDR_CASECONF\\cond_reports\\Published_reports\\abdr_website\\images\\sf_plot_map_EBSTE.rds")
 ggplotly(geo_plot) %>%
  layout(xaxis = list(autorange = TRUE),
         yaxis = list(autorange = TRUE))

geo_tbl <- readRDS("R:\\ABDR\\Analysis_New\\ABDR_CASECONF\\cond_reports\\Published_reports\\abdr_website\\images\\geo_tbl_EBSTE.rds")
...
t6 <- readRDS("R:/ABDR/Analysis_New/ABDR_CASECONF/cond_reports/Published_reports/abdr_website/images/t6_EBSTE.Rds")
t7 <- readRDS("R:/ABDR/Analysis_New/ABDR_CASECONF/cond_reports/Published_reports/abdr_website/images/t7_EBSTE.Rds")
...
plot <- readRDS("R:/ABDR/Analysis_New/ABDR_CASECONF/cond_reports/Published_reports/abdr_website/images/accomp_diag_EBSTE.Rds")
...
## References
[[1]](https://www.chop.edu/conditions-diseases/ebstein-s-anomaly-tricuspid-valve) Ebstein’s Anomaly of the Tricuspid Valve | Children's Hospital of Philadelphia. (2021). Retrieved 1 April 2021, from https://www.chop.edu/conditions-diseases/ebstein-s-anomaly-tricuspid-valve

[[2]](https://www.mayoclinic.org/diseases-conditions/ebsteins-anomaly/symptoms-causes/syc-20352127) Ebstein anomaly - Symptoms and causes. (2021). Retrieved 1 April 2021, from https://www.mayoclinic.org/diseases-conditions/ebsteins-anomaly/symptoms-causes/syc-20352127

[[3]]( https://www.heart.org/en/health-topics/congenital-heart-defects/about-congenital-heart-defects/ebsteins-anomaly)Ebstein's Anomaly. (2021). Retrieved 1 April 2021, from https://www.heart.org/en/health-topics/congenital-heart-defects/about-congenital-heart-defects/ebsteins-anomaly
      
[[4]](https://www.childrenshospital.org/conditions-and-treatments/conditions/e/ebsteins-anomaly) Ebstein's Anomaly | Boston Children's Hospital. (2021). Retrieved 31 March 2021, from https://www.childrenshospital.org/conditions-and-treatments/conditions/e/ebsteins-anomaly
...
## Suggested Citation
State of Alaska Department of Health, Division of Public Health, Section of Women's, Children's, and Family Health. Alaska Birth Defects Registry Condition Report: Ebstein anomaly, Alaska, 2007-`r as.numeric(format(Sys.time(), '%Y')) - 3`. Available at: http://rpubs.com/AK_ABDR/ebste.
...
*Code source:* ```R:\ABDR\Analysis_New\ABDR_CASECONF\cond_reports\Published_reports\Targets_publications\ebste_tar.qmd```   
