---
title: "Trisomy 21 (Down Syndrome) 2007-`r as.numeric(format(Sys.time(), '%Y')) - 3`"
...
### Prevalence 
Down syndrome is the most common Trisomy, occurring in **14.14 (95% CI 13.81–14.48) out of every 10,000 live births in the United States.** This results in about 6,000 babies diagnosed with Down syndrome nationally each year.[[2]](#references), [[6]](#references) 
...
# Loading the TRI21
ev2 <- readRDS("R:/ABDR/Analysis_New/ABDR_CASECONF/cond_reports/Published_reports/abdr_website/images/ev2_num_TRI21.rds") #
...
tmp <- readRDS("R:\\ABDR\\Analysis_New\\ABDR_CASECONF\\cond_reports\\Published_reports\\abdr_website\\images\\tmp_TRI21.rds")
tmp[[1]]
```  
...
library(plotly)
 ...
 trend <- readRDS("R:\\ABDR\\Analysis_New\\ABDR_CASECONF\\cond_reports\\Published_reports\\abdr_website\\images\\trend_nma_TRI21.rds")
  
 trend_table <- readRDS("R:\\ABDR\\Analysis_New\\ABDR_CASECONF\\cond_reports\\Published_reports\\abdr_website\\images\\trend_table_nma_TRI21.rds")
...
#| echo: false
 ...
 p_val <- readRDS("R:\\ABDR\\Analysis_New\\ABDR_CASECONF\\cond_reports\\Published_reports\\abdr_website\\images\\trend_p_table_TRI21.rds")
...
geo_plot <- readRDS("R:\\ABDR\\Analysis_New\\ABDR_CASECONF\\cond_reports\\Published_reports\\abdr_website\\images\\sf_plot_map_TRI21.rds")
 ggplotly(geo_plot) %>%
  layout(xaxis = list(autorange = TRUE),
         yaxis = list(autorange = TRUE))

geo_tbl <- readRDS("R:\\ABDR\\Analysis_New\\ABDR_CASECONF\\cond_reports\\Published_reports\\abdr_website\\images\\geo_tbl_TRI21.rds")
...
t6 <- readRDS("R:/ABDR/Analysis_New/ABDR_CASECONF/cond_reports/Published_reports/abdr_website/images/t6_TRI21.Rds")
t7 <- readRDS("R:/ABDR/Analysis_New/ABDR_CASECONF/cond_reports/Published_reports/abdr_website/images/t7_TRI21.Rds")
...
plot <- readRDS("R:/ABDR/Analysis_New/ABDR_CASECONF/cond_reports/Published_reports/abdr_website/images/accomp_diag_TRI21.Rds")
...
## References
[[1]](https://ghr.nlm.nih.gov/condition/down-syndrome.pdf) NIH U.S. National Library of Medicine. Genetics Home Reference: Down Syndrome, https<span></span>://ghr.nlm.nih.gov/condition/down-syndrome.pdf; 2017 [accessed 02.23.2017]  

[[2]](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3991414/pdf/FVVinObGyn-3-15-21.pdf) Witters I, Van Robays J, Willekes C et al. Trisomy 12,18, 21, Triploidy and Turner syndrome: the 5T's. Look at the hands. Facts, Views & Vision in ObGyn 2011; 3(1): 15-21. 

[[3]](https://www.cdc.gov/ncbddd/birthdefects/downsyndrome.html) Centers for Disease Control and Prevention, Facts about Down Syndrome, https<span></span>://www.cdc.gov/ncbddd/birthdefects/downsyndrome.html; 2016 [accessed 02.23.2017]

[[4]]( https://www.ncbi.nlm.nih.gov/pubmed/27600794) Copped F. Risk factors for Down syndrome. Archives of Toxicology 2016; 90(12): 2917-2929.  

[[5]](https://www.ncbi.nlm.nih.gov/pubmed/?term=Maternal+age+effect%3A+the+enigma+of+Down+syndrome+and+other+trisomic+conditions) Gaulden ME. Maternal age effect: the enigma of Down syndrome and other trisomic conditions. Mutation Research 1992; 296(1-2):69-88 
...
## Resources 
[National Down Syndrome Society](http://www.ndss.org/Down-Syndrome/What-Is-Down-Syndrome/)  
[Centers for Diesase Control and Prevention](https://www.cdc.gov/ncbddd/birthdefects/downsyndrome.html)    
...
## Suggested Citation
State of Alaska Department of Health, Division of Public Health, Section of Women's, Children's, and Family Health. Alaska Birth Defects Registry Condition Report: Trisomy 21, Alaska, 2007-`r as.numeric(format(Sys.time(), '%Y')) - 3`. Updated `r format(Sys.time(), '%B %d, %Y')` Available at: http://rpubs.com/AK_ABDR/Trisomy21.
...
*Code source:* ```R:\ABDR\Website\ABDR_Quarto_Website\Trisomy21_tar.qmd```  
