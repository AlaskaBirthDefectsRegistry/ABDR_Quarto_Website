---
title:  "Coarctation of the Aorta 2007-`r as.numeric(format(Sys.time(), '%Y')) - 3`"
...
Coarctation of the aorta is a birth defect in which part of the aorta, the main artery that carries oxygenated blood from the heart to the rest of the body, is narrowed. This narrowing, or coarctation, results in reduced blood flow to the lower body. [[1]](#references) Coarctation of the aorta is usually diagnosed after birth,  as prenatal diagnosis is especially difficult. How early in life the diagnosis is made depends on how mild or severe symptoms are which include respiratory distress, heart failure, and decreased or weaker pulses in the groin and legs. [[2]](#references) Pulse oximetry screening in the first few days of life may or may not detect coarctation of the aorta. Once suspected, an echocardiogram is commonly used to confirm the diagnosis. Treatment strategies include various surgeries or procedures that remove, bypass, or repair the narrowed section of the aorta. [[3]](#references) Because an infant with coarctation of the aorta may need these procedures soon after birth, this defect is considered a critical congenital heart defect. Causes of coarctation of the aorta are unknown. However, coarctation of the aorta and other heart defects like it are thought to be caused by a combination of genetic and environmental factors. [[4]](#references)

<br>

<iframe width="812" height="456.75" 
  src="https://www.youtube.com/embed/HbUrfLgE2FE" 
  title="Explainer video: What is Coarctation of the Aorta. From Cincinnati Children's Hospital"
  frameborder="0" 
  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" 
  allowfullscreen 
  data-external="1">
</iframe>
<p><a href="https://www.youtube.com/watch?v=HbUrfLgE2FE">
  Watch this video on YouTube: Coarctation of the Aorta explained
</a> (opens in YouTube, where captions are available)</p>
...
### Prevalence   
Coarctation of the Aorta occurs in about **5.57 (95% CI 5.36-5.79) out of every 10,000 live births in the United States.** This results in about 2,200 babies diagnosed with coarctation of the Aorta nationally each year.[[1, 4]](#references)
...
# Create a label for the condition to be used
  condition <- ("Coarctation at the Aorta")                                                
...
# Loading the ANEN
ev2 <- readRDS("R:/ABDR/Analysis_New/ABDR_CASECONF/cond_reports/Published_reports/abdr_website/images/ev2_num_COARC.rds") #
...
#| message: FALSE 
#| echo: false
tmp <- readRDS("R:\\ABDR\\Analysis_New\\ABDR_CASECONF\\cond_reports\\Published_reports\\abdr_website\\images\\tmp_COARC.rds")
tmp[[1]]
```  
...
library(plotly)
 ...
 trend <- readRDS("R:\\ABDR\\Analysis_New\\ABDR_CASECONF\\cond_reports\\Published_reports\\abdr_website\\images\\trend_nma_COARC.rds")
  
 trend_table <- readRDS("R:\\ABDR\\Analysis_New\\ABDR_CASECONF\\cond_reports\\Published_reports\\abdr_website\\images\\trend_table_nma_COARC.rds")
...
#| message: FALSE 
#| echo: false
 p_val <- readRDS("R:\\ABDR\\Analysis_New\\ABDR_CASECONF\\cond_reports\\Published_reports\\abdr_website\\images\\trend_p_table_COARC.rds")
...
#| message: FALSE 
#| echo: false
geo_plot <- readRDS("R:\\ABDR\\Analysis_New\\ABDR_CASECONF\\cond_reports\\Published_reports\\abdr_website\\images\\sf_plot_map_COARC.rds")
 ggplotly(geo_plot) %>%
  layout(xaxis = list(autorange = TRUE),
         yaxis = list(autorange = TRUE))

geo_tbl <- readRDS("R:\\ABDR\\Analysis_New\\ABDR_CASECONF\\cond_reports\\Published_reports\\abdr_website\\images\\geo_tbl_COARC.rds")
...
t6 <- readRDS("R:/ABDR/Analysis_New/ABDR_CASECONF/cond_reports/Published_reports/abdr_website/images/t6_COARC.Rds")
t7 <- readRDS("R:/ABDR/Analysis_New/ABDR_CASECONF/cond_reports/Published_reports/abdr_website/images/t7_COARC.Rds")
...
#| message: FALSE 
#| echo: false
plot <- readRDS("R:/ABDR/Analysis_New/ABDR_CASECONF/cond_reports/Published_reports/abdr_website/images/accomp_diag_COARC.Rds")
...
## References
[[1]]( https://www.chop.edu/conditions-diseases/coarctation-aorta) Coarctation of the Aorta | Children's Hospital of Philadelphia. (2021). Retrieved 22 January 2021, from https://www.chop.edu/conditions-diseases/coarctation-aorta 

[[2]]( https://www.heart.org/en/health-topics/congenital-heart-defects/about-congenital-heart-defects/coarctation-of-the-aorta-coa) Coarctation of the Aorta (CoA). (2021). Retrieved 22 January 2021, from https://www.heart.org/en/health-topics/congenital-heart-defects/about-congenital-heart-defects/coarctation-of-the-aorta-coa

[[3]]( https://www.mayoclinic.org/diseases-conditions/coarctation-of-the-aorta/symptoms-causes/syc-20352529) Coarctation of the aorta - Symptoms and causes. (2021). Retrieved 22 January 2021, from https://www.mayoclinic.org/diseases-conditions/coarctation-of-the-aorta/symptoms-causes/syc-20352529  

[[4]](https://onlinelibrary.wiley.com/doi/abs/10.1002/bdr2.1589) Mai CT, Isenburg JL, Canfield MA, Meyer RE, Correa A, Alverson CJ, Lupo PJ, Riehle‐Colarusso T, Cho SJ, Aggarwal D, Kirby RS. National population‐based estimates for major birth defects, 2010–2014. Birth Defects Research. 2019; 111(18): 1420-1435 
      

## Resources 
[Centers for Disease Control and Prevention](https://www.cdc.gov/ncbddd/heartdefects/coarctationofaorta.html)

[Cincinnati Children':Coarctation of the Aorta](https://www.cincinnatichildrens.org/health/c/coarctation)  
...
## Suggested Citation
State of Alaska Department of Health, Division of Public Health, Section of Women's, Children's, and Family Health. Alaska Birth Defects Registry Condition Report: Coarctation of the Aorta, Alaska, 2007-`r as.numeric(format(Sys.time(), '%Y')) - 3`. Updated `r format(Sys.time(), '%B %d, %Y')`. Available at: http://rpubs.com/AK_ABDR/Coarctation_of_the_Aorta.aspx
...
*Code source:* ```R:\ABDR\Website\ABDR_Quarto_Website\Coarctation_Aorta_tar.qmd```   
