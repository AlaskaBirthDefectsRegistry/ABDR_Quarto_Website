---
title: "Double Outlet Right Ventricle 2007-`r as.numeric(format(Sys.time(), '%Y')) - 3`"
...
Double Outlet Right Ventricle (DORV) is a rare congenital heart defect where the heart’s two major arteries both connect to the right ventricle. [[1]](#references) Normally, the left ventricle pumps oxygen-rich blood out of the heart through the aorta, while the right ventricle pumps oxygen-poor blood out through the pulmonary artery. With DORV, oxygen-poor blood can be circulated throughout the body via the opening between the right ventricle and aorta. [[2]](#references) Signs and symptoms of DORV may vary depending on how much oxygenated blood is reaching the body and the presence of associated defects. In most cases, babies will have symptoms in the first days or weeks of life, including: cyanosis (blue skin color), sweating, lethargy, rapid breathing, and heart murmur. [[3]](#references) DORV can be diagnosed prenatally by ultrasound and after birth by pulse oximetry, electrocardiogram, chest x-ray and echocardiogram. Medications may be necessary early on to help the heart function better prior to and after surgical intervention within the first year of life. Because an infant with double outlet right ventricle may need these procedures soon after birth, this defect is considered a critical congenital heart defect. The cause of DORV is not well understood. 
...
### Prevalence   
Double outlet right ventricle occurs in about **1.67 (95% CI 1.55–1.79) in every 6,000 to 10,000 live births in the United States.** [[4]](#references)
...
# Create a label for the condition to be used
  condition <- ("Double outlet right ventricle")                                                 #
...
# Loading the DORV
ev2 <- readRDS("R:/ABDR/Analysis_New/ABDR_CASECONF/cond_reports/Published_reports/abdr_website/images/ev2_num_DORV.rds") #
...
#| message: FALSE 
#| echo: false
tmp <- readRDS("R:\\ABDR\\Analysis_New\\ABDR_CASECONF\\cond_reports\\Published_reports\\abdr_website\\images\\tmp_DORV.rds")
tmp[[1]]
```
...
library(plotly)
 ...
 trend <- readRDS("R:\\ABDR\\Analysis_New\\ABDR_CASECONF\\cond_reports\\Published_reports\\abdr_website\\images\\trend_nma_DORV.rds")
  
 trend_table <- readRDS("R:\\ABDR\\Analysis_New\\ABDR_CASECONF\\cond_reports\\Published_reports\\abdr_website\\images\\trend_table_nma_DORV.rds")
...
#| message: FALSE 
#| echo: false
 p_val <- readRDS("R:\\ABDR\\Analysis_New\\ABDR_CASECONF\\cond_reports\\Published_reports\\abdr_website\\images\\trend_p_table_DORV.rds")
...
#| message: FALSE 
#| echo: false 
geo_plot <- readRDS("R:\\ABDR\\Analysis_New\\ABDR_CASECONF\\cond_reports\\Published_reports\\abdr_website\\images\\sf_plot_map_DORV.rds")
 ggplotly(geo_plot) %>%
  layout(xaxis = list(autorange = TRUE),
         yaxis = list(autorange = TRUE))

geo_tbl <- readRDS("R:\\ABDR\\Analysis_New\\ABDR_CASECONF\\cond_reports\\Published_reports\\abdr_website\\images\\geo_tbl_DORV.rds")
...
t6 <- readRDS("R:/ABDR/Analysis_New/ABDR_CASECONF/cond_reports/Published_reports/abdr_website/images/t6_DORV.Rds")
t7 <- readRDS("R:/ABDR/Analysis_New/ABDR_CASECONF/cond_reports/Published_reports/abdr_website/images/t7_DORV.Rds")
...
plot <- readRDS("R:/ABDR/Analysis_New/ABDR_CASECONF/cond_reports/Published_reports/abdr_website/images/accomp_diag_DORV.Rds")
...
## References
[[1]](https://my.clevelandclinic.org/health/diseases/14733-double-outlet-right-ventricle/management-and-treatment) Double Outlet Right Ventricle Management and Treatment | Cleveland Clinic. (2021). Retrieved 29 January 2021, from https://my.clevelandclinic.org/health/diseases/14733-double-outlet-right-ventricle/management-and-treatment

[[2]]( https://www.childrenshospital.org/conditions-and-treatments/conditions/d/dorv) Double Outlet Right Ventricle (DORV) | Boston Children's Hospital. (2021). Retrieved 29 January 2021, from https://www.childrenshospital.org/conditions-and-treatments/conditions/d/dorv

[[3]]( https://www.chop.edu/conditions-diseases/double-outlet-right-ventricle) Double Outlet Right Ventricle | Children's Hospital of Philadelphia. (2021). Retrieved 29 January 2021, from https://www.chop.edu/conditions-diseases/double-outlet-right-ventricle
...
## Resources 
[Cedars-Sinai](https://www.cedars-sinai.org/health-library/diseases-and-conditions---pediatrics/d/double-outlet-right-ventricle.html)

[Seattle Children's:Transposition of the Great Arteries]((https://www.seattlechildrens.org/conditions/double-outlet-right-ventricle/))  
...
## Suggested Citation
State of Alaska Department of Health, Division of Public Health, Section of Women's, Children's, and Family Health. Alaska Birth Defects Registry Condition Report: Double outlet right ventricle, Alaska, 2007-`r as.numeric(format(Sys.time(), '%Y')) - 3`. Updated `r format(Sys.time(), '%B %d, %Y')`. Available at: http://rpubs.com/AK_ABDR/dorv.
...
*Code source:* ```R:\ABDR\Analysis_New\ABDR_CASECONF\cond_reports\Published_reports\Targets_publications\dorv_tar.qmd```   
