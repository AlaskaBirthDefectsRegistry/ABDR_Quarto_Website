---
title: "Transportation of the Great Arteries 2007-`r as.numeric(format(Sys.time(), '%Y')) - 3`"
...
Transposition of the great arteries (TGA) is a birth defect of the heart where the aorta and pulmonary arteries are transposed or reversed so that the aorta arises from the right ventricle and the pulmonary artery arise from the left ventricle. There are two forms of TGA, dextro and levo. Dextro (D-TGA) is more common and occurs when the aorta is to the right and in front of the pulmonary artery. [[1]](#references) The reversal of the arteries results in oxygen-poor blood being pumped back out into the body and oxygen-rich blood being sent back into the lungs. [[2]](#references) TGA may be diagnosed before birth by ultrasound, or after birth typically within a few hours or days by physical examination, pulse oximetry, or echocardiogram. [[3]](#references) Symptoms can include cyanosis (blue skin tone), respiratory distress, poor weight gain, and lack of appetite. [[4]](#references) Emergency procedures to stabilize newborns with TGA include medications (prostaglandin) and balloon atrial septostomy (a catheterization procedure to allow increased mixing of oxygenated blood to the right ventricle).  A common surgical treatment, typically done within the first month of life, is the arterial switch procedure where the aorta and pulmonary artery are switched back to their correct position. [[1]](#references) Because an infant with transposition of the great arteries may need these procedures soon after birth, this defect is considered a critical congenital heart defect. 

<br>

<iframe width="812" height="456.75" src="https://www.youtube.com/embed/lBGUtiBp8k8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen data-external = "1"></iframe>
...
### Prevalence   
Transportation of the great arteries occurs in about **2.93 (95% CI 2.78–3.09) out of every 10,000 live births in the United States.** This results in about 1,153 babies diagnosed with Transportation of the great arteries nationally each year.[[1]](#references), [[5]](#references)
...
# Create a label for the condition to be used
  condition <- ("Transportation of the great arteries")
...
# Loading the TGA
ev2 <- readRDS("R:/ABDR/Analysis_New/ABDR_CASECONF/cond_reports/Published_reports/abdr_website/images/ev2_num_TGA.rds") #
...
tmp <- readRDS("R:\\ABDR\\Analysis_New\\ABDR_CASECONF\\cond_reports\\Published_reports\\abdr_website\\images\\tmp_TGA.rds")
tmp[[1]]
```  
...
library(plotly)
 ...
 trend <- readRDS("R:\\ABDR\\Analysis_New\\ABDR_CASECONF\\cond_reports\\Published_reports\\abdr_website\\images\\trend_nma_TGA.rds")
  
 trend_table <- readRDS("R:\\ABDR\\Analysis_New\\ABDR_CASECONF\\cond_reports\\Published_reports\\abdr_website\\images\\trend_table_nma_TGA.rds")
...
#| echo: false
 ...
 p_val <- readRDS("R:\\ABDR\\Analysis_New\\ABDR_CASECONF\\cond_reports\\Published_reports\\abdr_website\\images\\trend_p_table_TGA.rds")
...
geo_plot <- readRDS("R:\\ABDR\\Analysis_New\\ABDR_CASECONF\\cond_reports\\Published_reports\\abdr_website\\images\\sf_plot_map_TGA.rds")
 ggplotly(geo_plot) %>%
  layout(xaxis = list(autorange = TRUE),
         yaxis = list(autorange = TRUE))

geo_tbl <- readRDS("R:\\ABDR\\Analysis_New\\ABDR_CASECONF\\cond_reports\\Published_reports\\abdr_website\\images\\geo_tbl_TGA.rds")
...
t6 <- readRDS("R:/ABDR/Analysis_New/ABDR_CASECONF/cond_reports/Published_reports/abdr_website/images/t6_TGA.Rds")
t7 <- readRDS("R:/ABDR/Analysis_New/ABDR_CASECONF/cond_reports/Published_reports/abdr_website/images/t7_TGA.Rds")
...
plot <- readRDS("R:/ABDR/Analysis_New/ABDR_CASECONF/cond_reports/Published_reports/abdr_website/images/accomp_diag_TGA.Rds")
...
## References
[[1]]( https://www.cdc.gov/ncbddd/heartdefects/d-tga.html) Congenital Heart Defects- Facts about dextro-Transposition of the Great Arteries (d-TGA)- (CDC). (2020). Retrieved 29 January 2021, from https://www.cdc.gov/ncbddd/heartdefects/d-tga.html

[[2]]( https://www.mayoclinic.org/diseases-conditions/transposition-of-the-great-arteries/symptoms-causes/syc-20350589) transposition of the great arteries. (2018). Retrieved 29 January 2021, from https://www.mayoclinic.org/diseases-conditions/transposition-of-the-great-arteries/symptoms-causes/syc-20350589

[[3]]( https://www.chop.edu/conditions-diseases/transposition-great-arteries) Transposition of the Great Arteries. (2021). Retrieved 29 January 2021, from https://www.chop.edu/conditions-diseases/transposition-great-arteries

[[4]]( https://www.childrenshospital.org/conditions-and-treatments/conditions/t/transposition-of-the-great-arteries/symptoms-and-causes) Transposition of the Great Arteries (TGA) | Symptoms & Causes. (2021). Retrieved 29 January 2021, from https://www.childrenshospital.org/conditions-and-treatments/conditions/t/transposition-of-the-great-arteries/symptoms-and-causes
...
## Resources 
[Centers for Disease Control and Prevention](https://www.cdc.gov/ncbddd/heartdefects/d-tga.html)

[Seattle Children's:Transposition of the Great Arteries]((https://www.seattlechildrens.org/conditions/transposition/))  
...
## Suggested Citation
State of Alaska Department of Health, Division of Public Health, Section of Women's, Children's, and Family Health. Alaska Birth Defects Registry Condition Report: Transposition of the Great Arteries, Alaska, 2007-`r as.numeric(format(Sys.time(), '%Y')) - 3`. Updated `r up_date[1]`. Available at: http://rpubs.com/AK_ABDR/TGA
...
*Code source:* ```R:\ABDR\Website\ABDR_Quarto_Website\TGA07_17.Rmd```  
