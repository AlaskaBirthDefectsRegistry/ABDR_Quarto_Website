---
title:  "Truncus Arteriosus (Common Truncus) 2007-`r as.numeric(format(Sys.time(), '%Y')) - 3`"
...
Truncus arteriosus is a birth defect of the heart that occurs when the aorta and pulmonary artery fail to separate into two distinct blood vessels. [[1]](#references) This leads to oxygenated and unoxygenated blod mixing before it is pumped to the rest of the body. [[2]](#references) This defect can be diagnosed during pregnancy using prenatal tests like ultrasound but may be missed or mis-diagnosed, or after birth by echocardiography, physical exam, and pulse oximetry.  [[3]](#references) Symptoms of truncus arteriosus after birth can be variable and include heart failure (respiratory distress, tachycardia, poor feeding, and excessive sweating) and blue skin (cyanosis). [[1]](#references) In addition, this defect is frequently associated with extracardiac defects and genetic syndromes, especially 22q11 deletion. [[1]](#references) Treatment for truncus arteriosus includes medications to improve cardiac function and remove excess fluid from the body along with surgery to repair the heart and blood vessels. [[1]](#references) Surgery is typically performed in the first few weeks of life and includes separating the pulmonary artery from the aorta, closing the ventricular septal defect, and creating  a connection between the right ventricle and the pulmonary artery with an artificial tube. [[4]](#references) Because an infant with truncus arteriosus needs these procedures soon after birth, this defect is considered a critical congenital heart defect.

<br>

<iframe width="812" height="456.75" 
src="https://www.youtube.com/embed/193JQ6LQRwI" 
  title="Explainer video: What is Truncus arteriosus. From Cincinnati Children's Hospital"
  frameborder="0" 
...
<p><a href="https://www.youtube.com/embed/193JQ6LQRwI">
  Watch this video on YouTube: Truncus arteriosus explained
...
### Prevalence   
Truncus arteriosus occurs in about **0.82 (95% CI 0.71–0.93) in every 10,000 live births in the United States.** [[5]](#references)
...
# Loading the TA
ev2 <- readRDS("R:/ABDR/Analysis_New/ABDR_CASECONF/cond_reports/Published_reports/abdr_website/images/ev2_num_TA.rds") #
...
#| message: FALSE 
#| echo: false
tmp <- readRDS("R:\\ABDR\\Analysis_New\\ABDR_CASECONF\\cond_reports\\Published_reports\\abdr_website\\images\\tmp_TA.rds")
tmp[[1]]
```  
...
library(plotly)
 ...
 trend <- readRDS("R:\\ABDR\\Analysis_New\\ABDR_CASECONF\\cond_reports\\Published_reports\\abdr_website\\images\\trend_nma_TA.rds")
  
 trend_table <- readRDS("R:\\ABDR\\Analysis_New\\ABDR_CASECONF\\cond_reports\\Published_reports\\abdr_website\\images\\trend_table_nma_TA.rds")
...
#| message: FALSE 
#| echo: false
 p_val <- readRDS("R:\\ABDR\\Analysis_New\\ABDR_CASECONF\\cond_reports\\Published_reports\\abdr_website\\images\\trend_p_table_TA.rds")
...
#| message: FALSE 
#| echo: false
geo_plot <- readRDS("R:\\ABDR\\Analysis_New\\ABDR_CASECONF\\cond_reports\\Published_reports\\abdr_website\\images\\sf_plot_map_TA.rds")
 ggplotly(geo_plot) %>%
  layout(xaxis = list(autorange = TRUE),
         yaxis = list(autorange = TRUE))

geo_tbl <- readRDS("R:\\ABDR\\Analysis_New\\ABDR_CASECONF\\cond_reports\\Published_reports\\abdr_website\\images\\geo_tbl_TA.rds")
...
#| message: FALSE 
#| echo: false
t6 <- readRDS("R:/ABDR/Analysis_New/ABDR_CASECONF/cond_reports/Published_reports/abdr_website/images/t6_TA.Rds")
t7 <- readRDS("R:/ABDR/Analysis_New/ABDR_CASECONF/cond_reports/Published_reports/abdr_website/images/t7_TA.Rds")
...
plot <- readRDS("R:/ABDR/Analysis_New/ABDR_CASECONF/cond_reports/Published_reports/abdr_website/images/accomp_diag_TA.Rds")
...
## References
[[1]](https://www.cdc.gov/ncbddd/heartdefects/truncusarteriosus.html) Congenital Heart Defects - Facts about Truncus Arteriosus | CDC. (2019). Retrieved 9 April 2021, from https://www.cdc.gov/ncbddd/heartdefects/truncusarteriosus.html

[[2]](https://www.chop.edu/conditions-diseases/truncus-arteriosus) Truncus Arteriosus | Children's Hospital of Philadelphia. (2021). Retrieved 9 April 2021, from https://www.chop.edu/conditions-diseases/truncus-arteriosus

[[3]]( https://www.mayoclinic.org/diseases-conditions/truncus-arteriosus/diagnosis-treatment/drc-20364277) Truncus arteriosus - Diagnosis and treatment - Mayo Clinic. (2021). Retrieved 9 April 2021, from https://www.mayoclinic.org/diseases-conditions/truncus-arteriosus/diagnosis-treatment/drc-20364277
      
[[4]](https://www.cincinnatichildrens.org/health/t/truncus) Truncus Arteriosus | Symptoms, Repair & Prognosis . (2021). Retrieved 9 April 2021, from https://www.cincinnatichildrens.org/health/t/truncus
...
[Seattle Children's:Transposition of the Great Arteries](https://www.seattlechildrens.org/conditions/truncus-arteriosus/)  
...
## Suggested Citation
State of Alaska Department of Health, Division of Public Health, Section of Women's, Children's, and Family Health. Alaska Birth Defects Registry Condition Report: Truncus Arteriosus, Alaska, 2007-`r as.numeric(format(Sys.time(), '%Y')) - 3`. Updated `r format(Sys.time(), '%B %d, %Y')`. Available at: http://rpubs.com/AK_ABDR/truncus_arteriosus.
...
*Code source:* ```R:\ABDR\Website\ABDR_Quarto_Website\Truncus_Arteriosus_tar.qmd```   
