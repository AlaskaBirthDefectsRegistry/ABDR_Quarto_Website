---
title: "Tricuspid Atresia 2007-`r as.numeric(format(Sys.time(), '%Y')) - 3`"
...
Tricuspid Atresia is a birth defect of the heart wherein the tricupsid valve, which controls blood flow between the two chambers on the right side of the heart (right atrium and right ventricle), forms incorrectly, or not at all. [[1]](#references) A malformed, or absent tricuspid valve affects blood flow to the right ventricle and the main pulmonary artery, causing them to be under-developed. [[2]](#references) It is common for newborns with tricuspid atresia to also have a hole between the right and left sides of the heart (either an atrial or ventricular septal defect). Through these defects, oxygen-rich and oxygen-poor blood mix and this mixture of blood is pumped to the rest of the body by the left ventricle. [[1]](#references) Tricuspid Atresia can be detected during pregnancy by ultrasound or after birth with pulse oximetry, chest x-ray, and echocardiogram. [[3]](#references) Symptoms of tricuspid atresia include respiratory distress, blue skin tone (cyanosis), sweating, feeding difficulties, and heart murmur. [[4]](#references) Currently, the cause of tricuspid atresia is unknown. Treatment of tricuspid atresia includes medications to strengthen the heart, remove excess fluid from the body, and one or more surgeries or procedures to increase blood flow to the lungs and bypass the poorly functioning right side of the heart. Because an infant with tricuspid atresia may need these procedures soon after birth, this defect is considered a critical congenital heart defect. 
...
### Prevalence   
Tricuspid Atresia occurs in about **1.03 (95% CI 0.93–1.13) in every 10,000 live births in the United States.** [[5]](#references), [[6]](#references)
...
# Loading the TVAS
ev2 <- readRDS("R:/ABDR/Analysis_New/ABDR_CASECONF/cond_reports/Published_reports/abdr_website/images/ev2_num_TVAS.rds") #
...
tmp <- readRDS("R:\\ABDR\\Analysis_New\\ABDR_CASECONF\\cond_reports\\Published_reports\\abdr_website\\images\\tmp_TVAS.rds")
tmp[[1]]
```  
...
library(plotly)
 ...
 trend <- readRDS("R:\\ABDR\\Analysis_New\\ABDR_CASECONF\\cond_reports\\Published_reports\\abdr_website\\images\\trend_nma_TVAS.rds")
  
 trend_table <- readRDS("R:\\ABDR\\Analysis_New\\ABDR_CASECONF\\cond_reports\\Published_reports\\abdr_website\\images\\trend_table_nma_TVAS.rds")
...
#| echo: false
 ...
 p_val <- readRDS("R:\\ABDR\\Analysis_New\\ABDR_CASECONF\\cond_reports\\Published_reports\\abdr_website\\images\\trend_p_table_TVAS.rds")
...
geo_plot <- readRDS("R:\\ABDR\\Analysis_New\\ABDR_CASECONF\\cond_reports\\Published_reports\\abdr_website\\images\\sf_plot_map_TVAS.rds")
 ggplotly(geo_plot) %>%
  layout(xaxis = list(autorange = TRUE),
         yaxis = list(autorange = TRUE))

geo_tbl <- readRDS("R:\\ABDR\\Analysis_New\\ABDR_CASECONF\\cond_reports\\Published_reports\\abdr_website\\images\\geo_tbl_TVAS.rds")
...
t6 <- readRDS("R:/ABDR/Analysis_New/ABDR_CASECONF/cond_reports/Published_reports/abdr_website/images/t6_TVAS.Rds")
t7 <- readRDS("R:/ABDR/Analysis_New/ABDR_CASECONF/cond_reports/Published_reports/abdr_website/images/t7_TVAS.Rds")
...
plot <- readRDS("R:/ABDR/Analysis_New/ABDR_CASECONF/cond_reports/Published_reports/abdr_website/images/accomp_diag_TVAS.Rds")
...
## References
[[1]](https://www.cdc.gov/ncbddd/heartdefects/tricuspid-atresia.html) Congenital Heart Defects - Facts about Tricuspid Atresia | CDC. (2019). Retrieved 12 April 2021, from https://www.cdc.gov/ncbddd/heartdefects/tricuspid-atresia.html

[[2]](https://www.mayoclinic.org/diseases-conditions/tricuspid-atresia/symptoms-causes/syc-20368392) Tricuspid atresia - Symptoms and causes. (2021). Retrieved 13 April 2021, from https://www.mayoclinic.org/diseases-conditions/tricuspid-atresia/symptoms-causes/syc-20368392

[[3]](https://www.chop.edu/conditions-diseases/tricuspid-atresia) Tricuspid Atresia | Children's Hospital of Philadelphia. (2021). Retrieved 13 April 2021, from https://www.chop.edu/conditions-diseases/tricuspid-atresia
      
[[4]](https://www.childrenshospital.org/conditions-and-treatments/conditions/t/tricuspid-atresia/symptoms-and-causes) Tricuspid Atresia | Symptoms & Causes | Boston Children's Hospital. (2021). Retrieved 13 April 2021, from https://www.childrenshospital.org/conditions-and-treatments/conditions/t/tricuspid-atresia/symptoms-and-causes

[[5]](https://pubmed.ncbi.nlm.nih.gov/31580536/) Mai CT, Isenburg JL, Canfield MA, Meyer RE, Correa A, Alverson CJ, Lupo PJ, Riehle-Colarusso T, Cho SJ, Aggarwal D, Kirby RS; National Birth Defects Prevention Network. National population-based estimates for major birth defects, 2010-2014. Birth Defects Res. 2019 Nov 1;111(18):1420-1435. doi: 10.1002/bdr2.1589. Epub 2019 Oct 3. PMID: 31580536; PMCID: PMC7203968.
...
## Resources 
[Centers for Disease Control and Prevention](https://www.cdc.gov/ncbddd/heartdefects/tricuspid-atresia.html)

[Seattle Children's:Transposition of the Great Arteries](https://www.seattlechildrens.org/conditions/tricuspid-atresia/)  
...
*Code source:* ```R:\ABDR\Website\ABDR_Quarto_Website\tricuspid_atresia_tar.qmd```   
